...
while section_height <= maximum_height:
    ...
    for product, shape in product_shapes:
        ...
        if len(section_edges) > 0:
            print
            "    {:<20}: {}".format(product.is_a(), product.Name)
            ...
            print
            "        number of faces = %d" % wires.Length()
    ...
    print
    "    Total section area  =", sum(surface_areas_per_section)
    print
...
print
"Total building section areas =", sum(surface_areas_per_building)