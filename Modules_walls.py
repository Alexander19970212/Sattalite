...
class Balance_mass:
    ...
    def goal_function2(self, args):
        ...
        for i, name in enumerate(self.history_args):
            self.change_position1(name, int(args[i * 4]), int(args[i * 4 + 1]), int(args[i * 4 + 2]),
                                  int(args[i * 4 + 3]) * 90)
...
if __name__ == '__main__':
    ...
    walls = [[50, 50, 0, 50, 60, 0, 50, 50, 10, 80, 60],
             # (x, y, z) of centre face, (x, y, z) of height, (x, y, z) of x-axis, x-bounds, y-boynds,
             [-50, -50, 0, 50, 60, 0, 50, 50, 10, 80, 60]]
